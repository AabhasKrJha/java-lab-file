// Given the annual examination Results of 10 students. 
// Write a program to read the data and determine total marks, highest marks in each subject and roll number of the student who scored it.
...
public class ExamResults{
    ...
    public static void main(String args[]){
        ...
        for(int i=0;i<10;i++){
            System.out.println("Enter the marks of the student "+rollno+" in 3 subjects separated byspaces");
