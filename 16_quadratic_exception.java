...
class QuadraticEquationSolver {
    public static void main (String args[]) {
        Scanner input = new Scanner (System.in); int coefficientA = input.nextInt ();
        int coefficientB = input.nextInt (); int coefficientC = input.nextInt ();
        double discriminantSquare =
