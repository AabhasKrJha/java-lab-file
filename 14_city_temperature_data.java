// WAP to print the maximum temperature and the city and day on which it was recorded, 
// followed by the minimum temperature and the city and day on which it was recorded
...
public class temperatureCatalog{
    ...
    public static void main(String args[]){
        ...
        System.out.println("The maximum temperature is "+max+" on day "+(maxday+1)+" incity "+(maxcity+1));
