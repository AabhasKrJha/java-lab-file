...
class Teacher extends Staff{
    ...
    Teacher(String Code, String Name, String Subject, int Publication){
        super(Code,Name); subject=Subject; publication=Publication;
    }
    void display(){
...
abstract class Typist extends Staff{ int speed;
    Typist(String Code, String Name, int Speed){ super(Code,Name);
        speed=Speed;
    } 
}

class Regular extends Typist{ int salary;
    Regular(String Code, String Name, int Speed, int Salary){ super(Code,Name,Speed);
        salary=Salary;
    }
    void display(){
        System.out.println("Code: " + code + "\nName: " + name + "\nSpeed: " + speed + "\nSalary: " + salary);
...
class Officer extends Staff{ String grade;
    Officer(String Code, String Name, String Grade){ super(Code,Name);
        grade=Grade;
    }
    void display(){
        System.out.println("Code: " + code + "\nName: " + name + "\nGrade: " + grade);
